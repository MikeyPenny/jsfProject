...
@Named("editFamil")
@ViewScoped
public class EditaFamiliaMB implements Serializable {
    ...
    public void seleccionarFamilia() {
        ...
        setFamiliaCve(famSel.getClave());
        setFamiliaStr(famSel.getFamilia());
    ...
    public void editarFamilia() {
        ...
        fam.setId_familia(famSel.getId_familia());
        ...
        ConexionBD c = new ConexionBD();
        FamiliaDAO dao = new FamiliaDAO(c.getConexion());
        int reg = dao.editarFamilia(fam);
        
        FacesContext context = FacesContext.getCurrentInstance();
        
        if(reg>0) {
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Correcto!", "Se editó la info de la "
                    + "familia"));
        }else {
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error!", "No se editó la información"));
        }
     ...
     * @return the famSel
     */
    public FamiliaMat getFamSel() {
        return famSel;
    }

    /**
     * @param famSel the famSel to set
     */
    public void setFamSel(FamiliaMat famSel) {
        this.famSel = famSel;
    }
