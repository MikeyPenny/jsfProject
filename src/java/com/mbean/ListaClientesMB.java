...
public class ListaClientesMB implements Serializable {
    ...
    private List<ClienteAltaBean> listCliente = new ArrayList<>();
    ...
    public void eliminaApod() {
        
        //System.out.println(listApod.size());
        //System.out.println(apodSel.getFechaNacApod());
        
       
        if(apodSel.getId_apoderado() > 0) {
            ConexionBD c = new ConexionBD();
            ClienteDAO dao = new ClienteDAO(c.getConexion());
            dao.eliminarApoderado(apodSel.getId_apoderado());
            c = new ConexionBD();
            dao = new ClienteDAO(c.getConexion());
            setListApod(dao.listarApoderados(clienteSel.getId_cliente()));
        }else {
            listApod.remove(apodSel);
        }
    ...
    public void leerClientes() {
        ...
        setListCliente(cd.leerClientes());
    ...
    public void agregarApoderado() {
        ...
        c = new ConexionBD();
        dao = new ClienteDAO(c.getConexion());
        setListApod(dao.listarApoderados(getId_cliente()));
    ...
    public void agregarBanco() {
        ...
        if(!b.getDiaNacBenef().equals("")) {
            b.setFechNacBenef(getDiaNacBenef()+"/"+getMesNacBenef()+"/"+getYearNacBenef());
        }else {
            b.setFechNacBenef("");
        }
        b.setRfcBenef(getRfcBenef());
        b.setCurpBenef(getCurpBenef());
        b.setId_cliente(id_cliente);
        ...
        c = new ConexionBD();
        dao = new ClienteDAO(c.getConexion());
        setListBanco(dao.listarBancos(getId_cliente()));
    ...
    public void eliminarBanco() {
        ...
        ConexionBD c = new ConexionBD();
        ClienteDAO dao = new ClienteDAO(c.getConexion());
        dao.eliminarBanco(bancoSel.getId_banco());
    ...
    public void editarCliente() {
        ...
        int reg = ed.editarCliente(client, listBanco, listApod, bankDelete, apodDelete);
        
        FacesContext context = FacesContext.getCurrentInstance();
        if(reg>0) {
            
            
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Correcto!", "Se editó la información del cliente"));
            
        }else {
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Error!", "No se edito la información del cliente"));
        }
     ...
     */
    public List<ClienteAltaBean> getListCliente() {
        leerClientes();
        return listCliente;
    }
     ...
     */
    public void setListCliente(List<ClienteAltaBean> listCliente) {
